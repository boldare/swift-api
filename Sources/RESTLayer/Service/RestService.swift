...
public class RestService {
     ...
     */
    public init(baseUrl: URL, apiPath: String? = nil, headerFields: [ApiHeader]? = nil, coderProvider: CoderProvider = DefaultCoderProvider(), fileManager: FileManager = DefaultFileManager()) {
...
public extension RestService {
     ...
     */
    @discardableResult
    func get<Response: Decodable>(type: Response.Type, from path: ResourcePath, with aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = false, completion: RestResponseCompletionHandler<Response>? = nil) -> ApiRequest {
     ...
     */
    @discardableResult
    func post<Request: Encodable, Response: Decodable>(_ value: Request?, at path: ResourcePath, aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = false, responseType: Response.Type? = nil, completion: RestResponseCompletionHandler<Response>? = nil) -> ApiRequest {
        let completion = completionHandler(for: Response.self, coder: coder, with: completion)
        return post(value, at: path, aditionalHeaders: aditionalHeaders, useProgress: useProgress, completion: completion)
    }
     ...
     */
    @discardableResult
    func post<Request: Encodable>(_ value: Request?, at path: ResourcePath, aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = false, completion: RestSimpleResponseCompletionHandler? = nil) -> ApiRequest {
     ...
     */
    @discardableResult
    func put<Request: Encodable, Response: Decodable>(_ value: Request?, at path: ResourcePath, aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = false, responseType: Response.Type? = nil, completion: RestResponseCompletionHandler<Response>? = nil) -> ApiRequest {
        let completion = completionHandler(for: Response.self, coder: coder, with: completion)
        return put(value, at: path, aditionalHeaders: aditionalHeaders, useProgress: useProgress, completion: completion)
    }
     ...
     */
    @discardableResult
    func put<Request: Encodable>(_ value: Request?, at path: ResourcePath, aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = false, completion: RestSimpleResponseCompletionHandler? = nil) -> ApiRequest {
        let completion = completionHandler(with: completion)
        return put(value, at: path, aditionalHeaders: aditionalHeaders, useProgress: useProgress, completion: completion)
    }
     ...
     */
    @discardableResult
    func patch<Request: Encodable, Response: Decodable>(_ value: Request?, at path: ResourcePath, aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = false, responseType: Response.Type? = nil, completion: RestResponseCompletionHandler<Response>? = nil) -> ApiRequest {
        let completion = completionHandler(for: Response.self, coder: coder, with: completion)
        return patch(value, at: path, aditionalHeaders: aditionalHeaders, useProgress: useProgress, completion: completion)
    }
     ...
     */
    @discardableResult
    func patch<Request: Encodable>(_ value: Request?, at path: ResourcePath, aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = false, completion: RestSimpleResponseCompletionHandler? = nil) -> ApiRequest {
        let completion = completionHandler(with: completion)
        return patch(value, at: path, aditionalHeaders: aditionalHeaders, useProgress: useProgress, completion: completion)
    }
     ...
     */
    @discardableResult
    func delete<Request: Encodable, Response: Decodable>(_ value: Request? = nil, at path: ResourcePath, aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = false, responseType: Response.Type? = nil, completion: RestResponseCompletionHandler<Response>? = nil) -> ApiRequest {
        let completion = completionHandler(for: Response.self, coder: coder, with: completion)
        return delete(value, at: path, aditionalHeaders: aditionalHeaders, useProgress: useProgress, completion: completion)
    }
     ...
     */
    @discardableResult
    func delete<Request: Encodable>(_ value: Request? = nil, at path: ResourcePath, aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = false, completion: RestSimpleResponseCompletionHandler? = nil) -> ApiRequest {
        let completion = completionHandler(with: completion)
        return delete(value, at: path, aditionalHeaders: aditionalHeaders, useProgress: useProgress, completion: completion)
    }
}
...
public extension RestService {
    ...
    /**
     ...
     - Returns: ApiRequest object which allows to follow progress and manage request.
     */
    func getFile(at path: ResourcePath, saveAt destinationUrl: URL, inBackground: Bool = true, aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = true, completion: RestSimpleResponseCompletionHandler? = nil) -> ApiRequest {
        let url = requestUrl(for: path)
        let headers = apiHeaders(adding: aditionalHeaders)
        let completion = completionHandler(with: completion)
    ...
    /**
     ...
     - Returns: ApiRequest object which allows to follow progress and manage request.
     */
    func postFile(from url: URL, at path: ResourcePath, inBackground: Bool = true, aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = true, completion: RestSimpleResponseCompletionHandler? = nil) -> ApiRequest {
        let destinationUrl = requestUrl(for: path)
        let headers = apiHeaders(adding: aditionalHeaders)
        let completion = completionHandler(with: completion)
    ...
    /**
     ...
     - Returns: ApiRequest object which allows to follow progress and manage request.
     */
    func putFile(from url: URL, at path: ResourcePath, inBackground: Bool = true, aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = true, completion: RestSimpleResponseCompletionHandler? = nil) -> ApiRequest {
        let destinationUrl = requestUrl(for: path)
        let headers = apiHeaders(adding: aditionalHeaders)
        let completion = completionHandler(with: completion)
    ...
    /**
     ...
     - Returns: ApiRequest object which allows to follow progress and manage request.
     */
    func patchFile(from url: URL, at path: ResourcePath, inBackground: Bool = true, aditionalHeaders: [ApiHeader]? = nil, useProgress: Bool = true, completion: RestSimpleResponseCompletionHandler? = nil) -> ApiRequest {
        let destinationUrl = requestUrl(for: path)
        let headers = apiHeaders(adding: aditionalHeaders)
        let completion = completionHandler(with: completion)
...
private extension RestService {
    ...
    func requestUrl(for path: ResourcePath) -> URL {
        if let apiPath = apiPath, !apiPath.isEmpty {
            return baseUrl.appendingPathComponent(apiPath).appendingPathComponent(path.rawValue)
        }
    ...
    func requestData<T: Encodable>(for value: T?) -> Data? {
...
private extension RestService {
    ...
    func post<Request: Encodable>(_ value: Request?, at path: ResourcePath, aditionalHeaders: [ApiHeader]?, useProgress: Bool, completion: ApiResponseCompletionHandler?) -> ApiRequest {
        let url = requestUrl(for: path)
        let data = requestData(for: value)
        let headers = apiHeaders(adding: aditionalHeaders)
    ...
    func put<Request: Encodable>(_ value: Request?, at path: ResourcePath, aditionalHeaders: [ApiHeader]?, useProgress: Bool, completion: ApiResponseCompletionHandler?) -> ApiRequest {
        let url = requestUrl(for: path)
        let data = requestData(for: value)
        let headers = apiHeaders(adding: aditionalHeaders)
    ...
    func patch<Request: Encodable>(_ value: Request?, at path: ResourcePath, aditionalHeaders: [ApiHeader]?, useProgress: Bool, completion: ApiResponseCompletionHandler?) -> ApiRequest {
        let url = requestUrl(for: path)
        let data = requestData(for: value)
        let headers = apiHeaders(adding: aditionalHeaders)
    ...
    func delete<Request: Encodable>(_ value: Request?, at path: ResourcePath, aditionalHeaders: [ApiHeader]?, useProgress: Bool, completion: ApiResponseCompletionHandler?) -> ApiRequest {
        let url = requestUrl(for: path)
        let data = requestData(for: value)
        let headers = apiHeaders(adding: aditionalHeaders)
