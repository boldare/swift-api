...
Pod::Spec.new do |s|
  ...
  s.name         = "Swift-API"
  s.version      = "0.0.1"
  s.summary      = "Swift-API - internal XSolve library for API, written in Swift 3"
  ...
  s.source       = { :git => "https://github.com:xsolve-pl/swift-api.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Swift-API/**/*.{swift}"
